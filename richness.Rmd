...
turnover = function(beta_pair, species, cluster, cluster_names, fixed_max_turnover = 0.2) {
  ...
  ggplot(turnover_df, aes(x = cluster_from, y = cluster_to, fill = turnover)) +
    ...
    labs(
      title = paste("Turnover within", cluster, "clustered habitat"),
      x = "Cluster",
      y = "Cluster",
      fill = "Turnover"
    ) + 
...
row_turnover1 = cowplot::plot_grid(
  ...
  insect_b2_turnover + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), axis.text.y = element_blank(), plot.title = title_size),
  ncol = 2,
...
row_turnover2 = cowplot::plot_grid(
  ...
  plant2_turnover + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), axis.text.y = element_blank(), plot.title = title_size),
  ncol = 2,
  rel_widths = rel_widths
)
...
row_turnover3 = cowplot::plot_grid(
  ...
  bird2_turnover + theme(axis.title.x = element_blank(), axis.text.x = label_size, axis.text.y = element_blank(), plot.title = title_size),
  ncol = 2,
  rel_widths = rel_widths
)
