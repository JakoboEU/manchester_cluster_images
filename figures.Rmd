...
```{r}
jpeg('output/figure_1_20m_habitat_plots.jpg', width = 2100, height = 2700, units = "px", res = 300)
...
```{r}
jpeg('output/figure_1_120m_habitat_plots.jpg', width = 2100, height = 2700, units = "px", res = 300)
